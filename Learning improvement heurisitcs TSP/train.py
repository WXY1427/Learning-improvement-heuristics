...
#         rec_v = rec_v.cuda()
        ...
        for T in range(1000):
            ...
            pre_length, log_likelihood, current_length, rec_v, em, exchange, entropy = model(batch_e, rec_v, input_info, pos_enc, em, exchange, pre_length=current_length)
...
#     rec = rec.cuda()
    ...
    for U in range(50):
        ...
        for T in range(4):  
            ...
            bl_val, val, input_info, pos_enc = baseline.eval(x, rec)       

            pre_length, log_likelihood, current_length, rec, em, exchange, entropy = model(x, rec, input_info, pos_enc, em, exchange, pre_length=current_length)   
