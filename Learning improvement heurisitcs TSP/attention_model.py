...
class AttentionModel(nn.Module):
    ...
    def forward(self, input, rec, input_info, pos, embed, exc, pre_length=None):
        """
        :param input: (batch_size, graph_size, node_dim) input node features
        :return:
        """
            
        embedding, soft_max, exchange, entropy = self.embedder(self.init_embed(input_info)+pos, embed, exc)            
